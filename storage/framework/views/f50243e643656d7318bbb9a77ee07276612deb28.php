<?php if($paginator->hasPages()): ?>
    <nav class="d-flex justify-items-center justify-content-center mt-5">
        ...
        <div class="d-flex flex-sm-fill align-items-center justify-content-center">
            <div>
                <ul class="pagination">
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>