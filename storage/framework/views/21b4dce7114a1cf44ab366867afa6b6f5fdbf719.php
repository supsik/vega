<?php $__env->startSection('title', $page->seo_title ?? $page->title . ' - ' . config('app.name')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['isActive' => true,'isDark' => true]); ?><?php echo e($page->title, false); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/pages.blade.php ENDPATH**/ ?>