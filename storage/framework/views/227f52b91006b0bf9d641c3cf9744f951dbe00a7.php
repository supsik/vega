                ...
                <div class="header__top">
                    <div class="header__contact-list">
                        <div class="header-contact">
                            Пункты рядом с вами:
                            <a href="https://mega-clinic.ru/" class="header-contact__address" itemprop="address" content="<?php echo e($variables->first_address, false); ?>">
                                <?php echo e($variables->first_address, false); ?>

                            </a>
                            <a href="https://mega-clinic.ru/" class="header-contact__address" itemprop="address" content="<?php echo e($variables->second_address, false); ?>">
...
<?php endif; ?>
<?php $component->withAttributes(['link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($variables->whatsapp_link),'icon' => 'whatsapp']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($variables->vk_link),'icon' => 'vk']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($variables->tg_link),'icon' => 'tg']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                            ...
                            <a class="header-contact__phone" href="tel:<?php echo e($variables->phone, false); ?>" itemprop="telephone">
                    ...
                    <div class="header__links">
                        <a class="btn btn-main header__link-btn header__link-btn--lk header__link-btn--appointment"
                           href="<?php echo e(route('account.index'), false); ?>">
                           <span>
                               <?php if(!auth()->user()): ?>
                                    Личный кабинет
                                <?php else: ?>
                                    <?php echo e(auth()->user()->getMedodsUser()['name'], false); ?>

                                <?php endif; ?>
                            </span>
                        </a>
                        <a class="btn btn-main header__link-btn header__link-btn--appointment"
                           href="<?php echo e(route('appointment.index'), false); ?>">
...
<!--                     <a class="btn btn-main header__link-btn header__link-btn--lk"
                       href="<?php echo e(route('account.index'), false); ?>">
                        <span class="d-none d-md-block">Личный кабинет</span>
                    </a> -->
                    <a class="btn btn-main header__link-btn header__link-btn--user d-md-none"
                       href="<?php echo e(route('account.index'), false); ?>">
                        <!-- <span class="header__link-number d-block d-md-none">4</span> -->
                        <?php if(!auth()->user()): ?>
                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_81_53)">
                                <path d="M17 19V17C17 15.9391 16.5786 14.9217 15.8284 14.1716C15.0783 13.4214 14.0609 13 13 13H5C3.93913 13 2.92172 13.4214 2.17157 14.1716C1.42143 14.9217 1 15.9391 1 17V19" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9 9C11.2091 9 13 7.20914 13 5C13 2.79086 11.2091 1 9 1C6.79086 1 5 2.79086 5 5C5 7.20914 6.79086 9 9 9Z" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
                        ...
                        <?php else: ?>
                            <span class="header__link-user">
                                <?php echo e(auth()->user()->getShortName(), false); ?>
                ...
                <div class="header__search search-form d-none d-md-block">
                    <form class="d-flex" action="<?php echo e(route('search'), false); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <div class="header__feedback">
                    <a class="header__feedback-phone" href="tel:<?php echo e($variables->phone, false); ?>">
                    ...
                    <div>
                        <ul class="mobile-menu__list">
                            <li class="mobile-menu__item">
                                <a href="<?php echo e(route('appointment.index'), false); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <g clip-path="url(#clip0_21_406)">
                                            ...
                                            <path d="M13 15.5H19" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M16 12.5L19 15.5L16 18.5" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                        <defs>
                            ...
                            <li class="mobile-menu__item">
                                <a href="<?php echo e(route('prices'), false); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 20 16" fill="none">
                                      <g clip-path="url(#clip0_81_39)">
                                        <path d="M1 3V7.172C1.00011 7.70239 1.2109 8.21101 1.586 8.586L7.296 14.296C7.74795 14.7479 8.36089 15.0017 9 15.0017C9.63911 15.0017 10.252 14.7479 10.704 14.296L14.296 10.704C14.7479 10.252 15.0017 9.63911 15.0017 9C15.0017 8.36089 14.7479 7.74795 14.296 7.296L8.586 1.586C8.21101 1.2109 7.70239 1.00011 7.172 1H3C2.46957 1 1.96086 1.21071 1.58579 1.58579C1.21071 1.96086 1 2.46957 1 3Z" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M16 14L17.592 12.408C18.4958 11.5041 19.0035 10.2782 19.0035 9C19.0035 7.72178 18.4958 6.4959 17.592 5.592L13 1" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M5.00023 5H4.99023" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                      </g>
                                      <defs>
                                ...
                                <a class="mobile-menu__item-icon" href="/analysis">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                      <g clip-path="url(#clip0_21_446)">
                                        <path d="M7 15L12 13.5" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M4.5 6.5L12.31 11.87" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M5 5L13 4" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 5C1 5.53043 1.21071 6.03914 1.58579 6.41421C1.96086 6.78929 2.46957 7 3 7C3.53043 7 4.03914 6.78929 4.41421 6.41421C4.78929 6.03914 5 5.53043 5 5C5 4.46957 4.78929 3.96086 4.41421 3.58579C4.03914 3.21071 3.53043 3 3 3C2.46957 3 1.96086 3.21071 1.58579 3.58579C1.21071 3.96086 1 4.46957 1 5Z" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12 13C12 13.5304 12.2107 14.0391 12.5858 14.4142C12.9609 14.7893 13.4696 15 14 15C14.5304 15 15.0391 14.7893 15.4142 14.4142C15.7893 14.0391 16 13.5304 16 13C16 12.4696 15.7893 11.9609 15.4142 11.5858C15.0391 11.2107 14.5304 11 14 11C13.4696 11 12.9609 11.2107 12.5858 11.5858C12.2107 11.9609 12 12.4696 12 13Z" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M13 4C13 4.79565 13.3161 5.55871 13.8787 6.12132C14.4413 6.68393 15.2044 7 16 7C16.7956 7 17.5587 6.68393 18.1213 6.12132C18.6839 5.55871 19 4.79565 19 4C19 3.20435 18.6839 2.44129 18.1213 1.87868C17.5587 1.31607 16.7956 1 16 1C15.2044 1 14.4413 1.31607 13.8787 1.87868C13.3161 2.44129 13 3.20435 13 4Z" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 16C1 16.7956 1.31607 17.5587 1.87868 18.1213C2.44129 18.6839 3.20435 19 4 19C4.79565 19 5.55871 18.6839 6.12132 18.1213C6.68393 17.5587 7 16.7956 7 16C7 15.2044 6.68393 14.4413 6.12132 13.8787C5.55871 13.3161 4.79565 13 4 13C3.20435 13 2.44129 13.3161 1.87868 13.8787C1.31607 14.4413 1 15.2044 1 16Z" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                      </g>
                                      <defs>
                                ...
                                <a class="mobile-menu__item-icon" href="/about">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                      <g clip-path="url(#clip0_23_551)">
                                        <path d="M3 19V3C3 2.46957 3.21071 1.96086 3.58579 1.58579C3.96086 1.21071 4.46957 1 5 1H15C15.5304 1 16.0391 1.21071 16.4142 1.58579C16.7893 1.96086 17 2.46957 17 3V19" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M7 19V15C7 14.4696 7.21071 13.9609 7.58579 13.5858C7.96086 13.2107 8.46957 13 9 13H11C11.5304 13 12.0391 13.2107 12.4142 13.5858C12.7893 13.9609 13 14.4696 13 15V19" stroke="#3C515C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 19H19" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M8 7H12" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M10 5V9" stroke="#A1BF43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                      </g>
                                      <defs>
