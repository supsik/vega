<?php if($resource->bulkActionsCollection()->onlyVisible()->inDropdown()->isNotEmpty()): ?>
...
<?php endif; ?>
    ...
    <ul class="dropdown-menu">
        <?php $__currentLoopData = $resource->bulkActionsCollection()->onlyVisible()->inDropdown(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="dropdown-menu-item">
                <?php echo $__env->make('moonshine::crud.shared.bulk-action-item', [
                    'action' => $action,
                    'resource' => $resource,
                    'index' => $index
...
<?php $__currentLoopData = $resource->bulkActionsCollection()->onlyVisible()->inLine(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <?php echo $__env->make('moonshine::crud.shared.bulk-action-item', [
        'action' => $action,
        'resource' => $resource,
        'index' => $index
...
<?php if($resource->can('massDelete') && in_array('delete', $resource->getActiveActions())): ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component->withAttributes(['title' => ''.e(trans('moonshine::ui.deleting'), false).'']); ?>
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'moonshine::components.form.index','data' => ['method' => 'POST','action' => ''.e($resource->route('massDelete'), false).'','raw' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'POST','action' => ''.e($resource->route('massDelete'), false).'','raw' => true]); ?>
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'moonshine::components.form.input','data' => ['type' => 'hidden','name' => 'ids','class' => 'actionsCheckedIds','value' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'hidden','name' => 'ids','class' => 'actionsCheckedIds','value' => '']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/vendor/moonshine/moonshine/resources/views/crud/shared/bulk-actions.blade.php ENDPATH**/ ?>