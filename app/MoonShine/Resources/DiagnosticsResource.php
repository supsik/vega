...
class DiagnosticsResource extends Resource
{
    public static string $model = 'App\Models\Diagnostics';

    public static string $title = 'Диагностики';
            ...
            Block::make([
                Tabs::make([
                    Tab::make('Основное', [
                        ...
                        SwitchBoolean::make('Скрыть номер телефона', 'hide_phone')
                            ->hideOnDetail()
                            ->hideOnIndex(),
                        MediaLibrary::make('Анимация', 'animation'),
                    ]),
