...
class OperationBlockResource extends Resource
{
    public static string $model = 'App\Models\OperationBlock';

    public static string $title = 'Хирургическое отделение';
            ...
            Block::make([
                Tabs::make([
                    Tab::make('Основное', [
                        ...
                        BelongsToMany::make('Операции', 'operations', 'name')
                            ->select()
                            ->hideOnIndex(),
