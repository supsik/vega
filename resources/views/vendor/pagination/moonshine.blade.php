    ...
    @else
        ...
        <div class="pagination">
            <ul class="pagination-list">
                @if (!$paginator->onFirstPage())
                    <li class="pagination-item">
                        <a href="{{ $paginator->previousPageUrl() }}"
                           class="pagination-first" title="{!! __('moonshine::pagination.previous') !!}">
                            <x-moonshine::icon
                ...
                @foreach ($elements as $element)
                    ...
                    @if (is_array($element))
                        @foreach ($element as $page => $url)
                            <li class="pagination-item">
                                <a href="{{ $url }}"
                                   class="pagination-page @if ($page == $paginator->currentPage()) _is-active @endif">
                                    {{ $page }}
                                </a>
                            </li>
                        @endforeach
                ...
                @if ($paginator->hasMorePages())
                    <li class="pagination-item">
                        <a href="{{ $paginator->nextPageUrl() }}" class="pagination-last"
