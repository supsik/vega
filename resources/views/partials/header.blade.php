<header class="header">
    @if($variables->ngc_link)
        <div class="container-fluid d-none d-md-block">
            <a class="header__ngc" href="{{ $variables->ngc_link }}" target="_blank">
                МЕГА <br>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <div class="header__inner">
                ...
                <a class="header__logo navbar-brand p-0 d-md-none" href="{{ route('home') }}" itemprop="name" content="Мега Клиника">
                ...
                <div class="header__top">
                    <div class="header__contact-list">
                        <div class="header-contact">
                            ...
                            <a href="https://mega-clinic.ru/" class="header-contact__address" itemprop="address" content="{{ $variables->second_address }}">
